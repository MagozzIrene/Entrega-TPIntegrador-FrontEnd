...
const App = () => {
  ...
  return (
    <Routes>
      ...
      {isMobile && <Route path="/" element={<ContactScreen toggleTheme={toggleTheme} isLight={isLight} />} />}

      {!isMobile && <Route path="/*" element={<SplitScreenLayout toggleTheme={toggleTheme} isLight={isLight} />} />}
    </Routes>
  );
};
